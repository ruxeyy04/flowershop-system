                    ...
                    <div class="d-flex ">
                        <figure class="me-4 flex-shrink-0">
                            <div style="background-image: url('/profile_img/<?= $userinfo['image'] == null ? 'default.jpg' : $userinfo['image'] ?>'); background-position: center;
                                ...
                                width: 100px;
                                border-radius: 50%;
                                box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px; margin-right:40px">
                            </div>
                        </figure>
                        <div class="flex-fill">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="phone" value="<?= $userinfo['contact_number'] ?>" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="<?= $userinfo['usertype'] ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
if (isset($_POST['updateinfo'])) {
    ...
    $sql_profile = "
        UPDATE userinfo 
        SET fname = ?, midname = ?, lname = ?, contact_number = ?, gender = ?
        WHERE userid = ?";
